        ...
        <div className="flex justify-end gap-[12px]">
          {canDelete && (
            <button
              ...
              className="px-[24px] py-[12px] rounded-[8px] border border-[var(--color-text-primary)] font-title-small text-[var(--color-text-primary)] hover:bg-gray-100 transition-colors"
            >
              삭제
            </button>
          )}
          ...
          <div className="bg-white rounded-[16px] w-full max-w-[400px] mx-[16px] shadow-xl">
            ...
            <div className="px-[24px] py-[16px] border-t border-[var(--color-border-default)] flex justify-end gap-[12px]">
              ...
              <button
                ...
                className="px-[20px] py-[10px] rounded-[8px] bg-[var(--color-text-primary)] font-title-small text-white hover:opacity-80 transition-colors disabled:opacity-50"
              >
